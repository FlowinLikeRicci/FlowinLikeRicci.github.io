...
\begin{statement}{1.9}
We first deduce the Cauchy-Riemann equations in polar coordinates. Polar coordinates Notice that:
\begin{align*}
...
&= -\dfrac{\p v}{\p r}.
\end{align*}
Write $\log z = \log r + i\theta = u(r,\theta) + iv(r,\theta).$ By Theorem $2.4,$ it suffices to show $u$ and $v$ satisfy the Cauchy-Riemann equations. Clearly, for the given pairs $(r,\theta),$ we have
